...
class MilestoneTemplateDetailView extends React.Component<Props> {
          ...
          <Col span={24}>
            <Card>
              <Tabs defaultActiveKey="#"
                    activeKey={getTabKeyFromBrowserPath(history.location.hash, 'tab1')}
...
export default withRouter(connect(mapState, mapDispatch)(MilestoneTemplateDetailView));
