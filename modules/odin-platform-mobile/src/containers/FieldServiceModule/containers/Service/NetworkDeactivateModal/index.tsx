...
class NetworkDeactivateModal extends React.Component<Props> {
  ...
  handleOk = async () => {
    ...
    await httpPost(
      `ServiceModule/v1.0/network/adtrannnt/data/${record.id}/deactivate`,
      {},
    ).then(res => {
      console.log(res);
  ...
  render() {
    ...
    return (
      <>
        <Button type="primary" danger onClick={() => this.setState({ showModal: true })}>Deactivate</Button>
        <Modal
...
export default connect(mapState, mapDispatch)(NetworkDeactivateModal);
