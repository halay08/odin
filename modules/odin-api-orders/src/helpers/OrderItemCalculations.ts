...
export class OrderItemCalculations {
    ...
    public static computeLineItemTotal(
        ...
        const lineItemPreTaxTotal = Number(this.computeOrderItemPreTaxTotalPrice(orderItem, order));
        const lineItemTaxAmount = this.computeOrderItemTaxAmount(orderItem, order);
