    ...
    try {
        ...
        for(const product of products) {
            ...
            updateProduct.properties = {
                DescriptionLine1: sandboxProduct.properties.DescriptionLine1,
                DescriptionLine2: sandboxProduct.properties.DescriptionLine2,
                LegalTerms: sandboxProduct.properties.LegalTerms,
                Description: sandboxProduct.properties.Description,
            };
            ...
            console.log('productionProductRes', productionProductRes);
        }
    } catch (e) {
        console.error(e);
    }
