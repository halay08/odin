...
@Controller(`/${SERVICE_NAME.IDENTITY_MODULE}/v1.0/rbac/permissions/schemas/columns`)
export class OrganizationsSchemasColumnsRbacPermissionsController {
    private readonly schemasColumnsPermissionsService: OrganizationsSchemasColumnsRbacPermissionsService;

    public constructor(schemasColumnsPermissionsService: OrganizationsSchemasColumnsRbacPermissionsService) {
        this.schemasColumnsPermissionsService = schemasColumnsPermissionsService;
    }
    ...
    public async batchCreate(
        ...
        return await this.schemasColumnsPermissionsService.batchCreateByPrincipal(principal, schemaId, columnId);
    }
     ...
     * @param schemaId
     */
    @Delete('/batch/:schemaId/:columnId')
    @UseGuards(PrincipalGuard, PermissionsGuard)
    ...
    public async batchDeleteByPrincipalAndSchemaId(
       ...
       return await this.schemasColumnsPermissionsService.batchDeleteByPrincipalAndId(principal, schemaId, columnId);
    }
