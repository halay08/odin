...
describe('Feature models service', () => {
    ...
    let featureComponentsService: FeatureComponentsService;
    ...
    beforeEach(async () => {
        ...
        featureComponentsService = app.get<FeatureComponentsService>(FeatureComponentsService);
